...
const Auth = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (error) {
      toast.error('Fehler beim Senden der E-Mail', { description: error.message });
    } else {
      setForgotSent(true);
    }
            ...
            {view === 'login' ? (
              <form onSubmit={handleSignIn} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="signin-email" className="text-xs font-semibold text-gray-600 uppercase tracking-wide">
                    E-Mail
                  </Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="signin-password" className="text-xs font-semibold text-gray-600 uppercase tracking-wide">
                    Passwort
                  </Label>
                  <div className="relative">
                    <Input
                ...
                {forgotSent ? (
                  <div className="space-y-4 text-center">
                    <div className="rounded-xl bg-green-50 border border-green-200 p-4">
                      <p className="text-sm font-semibold text-green-700 mb-1">E-Mail versendet</p>
